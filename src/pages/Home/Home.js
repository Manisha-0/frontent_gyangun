...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div>
        <div className="Banner_Card">
          <Card  style={{ height: "315px", }}>
            <h1>Technology Driving Student 
              </h1>
              <h1>Success</h1>

            <hr />
            <p>
            Our mission is to provide an outstanding academic experience for
        ...
        <img
          ...
          alt=""
          src="https://img.freepik.com/premium-vector/digital-classroom-online-education-kindergarten-backto-school-concept-learning-phone-mobile-website-background-decor-by-blackboard-kid-children-student-desk-table-chair-3d-illustration_255625-30.jpg?w=996"
        />
      </div>
      {/* <About/> */}
      ...
      {/* <h3 className="section__title mt-3">A broad selection of courses:</h3>
      <h4 className="section__subtitle">"Choose from 204,000 online video courses with new additions published every month "</h4><br></br>
         */}
      ...
      */}
      ...
      <Container>
          ...
          <Col lg="12" className=" client1">
              ...
              <h6 className="section__subtitle">What our Client Says</h6>
            </Col>
